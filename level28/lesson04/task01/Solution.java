...
public class Solution {
    public static AtomicInteger numberOfFactories = new AtomicInteger(0);
    ...
    public static class AmigoThreadFactory implements ThreadFactory {
        ...
        AtomicInteger factoryOrder = new AtomicInteger(0);

        public AmigoThreadFactory() {
            synchronized (numberOfFactories) {
                numberOfFactories.incrementAndGet();
                factoryOrder.set(numberOfFactories.get());
            }
        }
        ...
        public Thread newThread(Runnable r) {
            ...
            result.setName(String.format("%s-pool-%s-thread-%s", result.getThreadGroup().getName(), factoryOrder, threadOrder.incrementAndGet()));
            return result;
        }
    }
}