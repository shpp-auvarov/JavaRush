        ...
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                if (stock1.get("name").equals(stock2.get("name"))) {
                    Date today1 = (Date) (stock1.get("date"));
                    Date myDate1 = new Date(today1.getYear(), today1.getMonth(), today1.getDay());
                    Date today2 = (Date) (stock2.get("date"));
                    Date myDate2 = new Date(today2.getYear(), today2.getMonth(), today2.getDay());
                    if (myDate1.compareTo(myDate2) == 0) {
                        ...
                        if(stock1.containsKey("open") && stock1.containsKey("last")){
                            open1 = (double) (stock1.get("open"));
                            last1 = (double) (stock1.get("last"));
                            result1 = last1 - open1;
                        }else{
                            result1 = (double)stock1.get("change");
                        }
                        if(stock2.containsKey("open") && stock2.containsKey("last")){
                            open2 = (double) (stock2.get("open"));
                            last2 = (double) (stock2.get("last"));
                            result2 = last2 - open2;
                        }else{
                            result2 = (double)stock2.get("change");
                        }
                        return Double.compare(result2,result1);
                    } else {
                        return -myDate2.compareTo(myDate1);
                    }
                } else {
